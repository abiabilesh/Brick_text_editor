...
Bricks:MAKEDIR $(ROOT_DIR_OBJ) $(CORE_DIR_OBJ) $(CORE_FILE_DIR_OBJ) $(SYS_DIR_OBJ) 
	$(CC) $(OUTPUT)/*.o $(OUTPUT)/core/*.o $(OUTPUT)/core/brick_file/*.o $(OUTPUT)/system/*.o -lpthread -o $(OUTPUT)/$(EXECUTABLE)

	
MAKEDIR:
	mkdir -p $(OUTPUT)/core/brick_file
